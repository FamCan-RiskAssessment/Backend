...
var Persian = map[string]interface{}{
	...
	"errors": map[string]interface{}{
		...
		"invalidType":            "نوع داده `{0}` نامعتبر است.",
		...
		"rateLimit":              "بیشتر از حد مجاز درخواست ثبت کرده اید.",
		...
		"calcAPIFailure":         "سرویس محاسبات برای مدل {0} در دسترس نیست. لطفا بعدا دوباره تلاش کنید.",
		...
		"serviceUnavailable":     "سرویس در دسترس نیست. لطفا بعدا دوباره تلاش کنید.",
		"smsUnavailableVPN":      "سرویس ارسال پیامک در دسترس نیست. اگر فیلتر شکن روشن است، آن را خاموش کنید و دوباره تلاش کنید.",
		"verificationFailed":     "احراز هویت با شماره تلفن و کد ملی ناموفق بود.",
	},
	"successMessage": map[string]interface{}{
		...
		"submitProfile":             "پروفایل شما با موفقیت ثبت شد.",
	},
